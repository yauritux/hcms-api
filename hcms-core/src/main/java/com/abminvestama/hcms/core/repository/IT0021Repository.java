...
public interface IT0021Repository extends CrudRepository<IT0021, ITCompositeKeys> {
	...
	@Query("FROM IT0021 it0021 WHERE it0021.pernr = :pernr AND it0021.id.infty = '0021' ORDER BY it0021.id.subty ASC, it0021.id.endda DESC")
	Collection<IT0021> findByPernr(@Param("pernr") Long pernr);
	
	@Query("FROM IT0021 it0021 WHERE it0021.pernr = :pernr AND it0021.id.infty = '0021' AND it0021.id.subty = :subty ORDER BY it0021.id.endda DESC")
